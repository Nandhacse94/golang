...
#### HandsOn Exercises  1
- create a value and assign it to variable and print address of variable

#### HandsOn Exercises  2
- create a person struct and create a func called "changeMe" and person as parameter
- change the value of person fields in changeMe func.
